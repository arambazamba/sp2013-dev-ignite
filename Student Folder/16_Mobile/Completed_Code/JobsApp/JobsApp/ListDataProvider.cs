...
namespace JobsApp
{
    ...
    public static class CamlQueryBuilder
    {
        ...
        /// </summary>
        static string ViewFields = @"<FieldRef Name='Title'/><FieldRef Name='Description'/><FieldRef Name='AssignedTo'/><FieldRef Name='Modified'/><FieldRef Name='Created'/><FieldRef Name='Author'/><FieldRef Name='Editor'/><FieldRef Name='_UIVersionString'/><FieldRef Name='Attachments'/>";
