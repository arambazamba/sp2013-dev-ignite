...
namespace GeoApp
{
    ...
    public static class CamlQueryBuilder
    {
        ...
        {   
            {"View1",   @"<View><Query><OrderBy><FieldRef Name='Title' /><FieldRef Name='FirstName' /></OrderBy></Query><RowLimit>30</RowLimit><ViewFields>{0}</ViewFields></View>"}
        };
        ...
        /// </summary>
        static string ViewFields = @"<FieldRef Name='FullName'/><FieldRef Name='HomePhone'/><FieldRef Name='Location'/><FieldRef Name='Title'/><FieldRef Name='LastNamePhonetic'/><FieldRef Name='FirstName'/><FieldRef Name='FirstNamePhonetic'/><FieldRef Name='Email'/><FieldRef Name='Company'/><FieldRef Name='CompanyPhonetic'/><FieldRef Name='JobTitle'/><FieldRef Name='WorkPhone'/><FieldRef Name='CellPhone'/><FieldRef Name='WorkFax'/><FieldRef Name='WorkAddress'/><FieldRef Name='WorkCity'/><FieldRef Name='WorkState'/><FieldRef Name='WorkZip'/><FieldRef Name='WorkCountry'/><FieldRef Name='WebPage'/><FieldRef Name='Comments'/><FieldRef Name='Modified'/><FieldRef Name='Created'/><FieldRef Name='Author'/><FieldRef Name='Editor'/><FieldRef Name='_UIVersionString'/><FieldRef Name='Attachments'/>";
